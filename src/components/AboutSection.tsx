export function AboutSection({ currentYear }: { currentYear: number }) {
  return (
    <section className="flex flex-col justify-center mt-8">
      <h1 className="text-4xl leading-[50px] font-semibold tracking-wider text-dark dark:text-white">About</h1>
      <p className="max-w-4xl text-lg text-dark dark:text-white font-medium leading-8 mt-4 tracking-[0.01em]">
