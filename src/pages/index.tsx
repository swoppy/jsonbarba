    ...
    <section className="flex flex-col justify-center mt-8">
      ...
      <p className="max-w-4xl text-lg text-[#2c3136] dark:text-white font-medium leading-8 mt-4 tracking-[0.01em]">
        <span className="font-semibold">
          Jason Joseph Barba</span> is a software engineer mainly focus on the web frontend development side of things to help build web-based software solutions and services.
          He spent over {currentYear - 2017} years working with various tech startups, mid-size organizations and even some larger ones. He likes to work on projects
